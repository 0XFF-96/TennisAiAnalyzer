    ...
    <nav className="bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/">
              <a className={`px-3 py-2 text-sm font-medium ${location === '/' ? 'text-green-600' : 'text-gray-900 hover:text-green-600'}`}>
                Home
              </a>
            </Link>
            <Link href="/history">
              <a className={`px-3 py-2 text-sm font-medium ${location === '/history' ? 'text-green-600' : 'text-gray-900 hover:text-green-600'}`}>
                History
              </a>
            </Link>
            <Button asChild className="ml-4 bg-green-600 hover:bg-green-700">
              <a href="/#upload">Sign In</a>
            </Button>
          </div>
        </div>
      </div>
